...
var vertStr = require('./shaders/vertex_ring.js')
var fragStr = require('./shaders/fragment_ring.js')
...
// create variable that cancels text perspective when camera rotates so text is always facing the camera 
...
// use loadObj tool to load the first 3d model: ring
...
// use loadObj tool to load the second 3d model: textPlane (to use as an object to apply text onto)
...
for (var i = 0; i < imagesBlueToLoad.length; i++) {
  ...
  img.src = './assets/mediaPortraitTexture/blueFlower/' + fileName + '.png'
  console.log(i, './assets/mediaPortraitTexture/blueFlower/' + fileName + '.png')
}
...
for (var i = 0; i < imagesYellowToLoad.length; i++) {
  ...
  img.src = './assets/mediaPortraitTexture/yellowFlower/' + fileName + '.png'
}
...
for (var i = 0; i < imagesRedToLoad.length; i++) {
  ...
  img.src = './assets/mediaPortraitTexture/redFlower/' + fileName + '.png'
}
...
for (var i = 0; i < imagesGreenToLoad.length; i++) {
  ...
  img.src = './assets/mediaPortraitTexture/greenFlower/' + fileName + '.png'
}
...
function render () {
  ...
  // positionOffsets.positionsOffsetsStem[0] is the position of each cluster in the array of relative positions
