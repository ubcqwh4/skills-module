module.exports = `                	   	   
	...
	// end of copied perlin noise 
	

	void main(){
		// float noiseValueBase = noise(vec3(uTime*2.0,vUV*3.0))
		float noiseValue = cnoise(vec3(vUV * 3.0, uTime));
		...
		vec3 red =vec3(127.0/255.0,183.0/255.0,190.0/255.0);
		vec3 yellow =vec3(1.0,1.0,0.0);


		// float tmp = clamp(noiseValue, 0.0, 1.0);

		vec3 finalColor = mix(red,yellow,noiseValue);
